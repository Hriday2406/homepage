    ...
    <header>
      ...
      <div className="h-right">
        ...
        <div className="about-text">
          <p>
            Hey! I'm Hriday Budhiraja, a passionate web developer specializing
            in creating clean, modern websites with seamless user experiences.
            With a keen eye for design and strong technical skills, I craft
            digital solutions that combine functionality and aesthetic appeal.
          </p>
          <p>
            My journey began during college when I discovered a love for coding.
            Since then, I've honed my skills through numerous projects,
          ...
          <p>
            ...
            I'm excited to contribute my skills to innovative projects that make
            a positive impact.
          </p>
        </div>
